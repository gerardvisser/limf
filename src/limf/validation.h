...
#ifndef LIMF__VALIDATION_INCLUDED
#define LIMF__VALIDATION_INCLUDED
...
# define validation_validateInteger(src, beforeOrAfter)
# define validation_validateIntegerLast0(src, beforeOrAfter)
